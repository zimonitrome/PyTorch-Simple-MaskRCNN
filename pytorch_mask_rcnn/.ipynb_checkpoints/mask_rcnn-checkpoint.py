...
class ResBackbone(nn.Module):
    def __init__(self, backbone_name, pretrained, n_input_channels=1):
        super().__init__()
        ...
        self.body["conv1"] = nn.Conv2d(n_input_channels, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
        in_channels = 2048
